...
import cn.lanedy.service.PermissionService;
...
//    @RequiresRoles(value = {"admin"})
    ...
    public JsonVO update(@RequestBody Permission permission) {
        try {
    ...
    public JsonVO create(@RequestBody Permission permission) {
        try {
    ...
    public List<TreeVO> getRolesZTree() {
        try {
