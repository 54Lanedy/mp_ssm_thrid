...
function findById(id) {
    var obj = {};
    $.ajax({
        url: '../../permissions/findById?id=' + id,
        type: 'get',
        async: false,
        success: (data) => {
            obj = data;
...
function findPermissionByRoleId(id) {
    var obj = {};
    $.ajax({
        url: '../../permissions/findRoleByPermissionId?id=' + id,
        type: 'get',
        async: false,
        success: (data) => {
            obj = data;
...
function surePermission() {
    ...
    //提交
    $.ajax({
        url: '../../permissions/updateRolesPermissions',
        type: 'post',
        dataType: 'json',
