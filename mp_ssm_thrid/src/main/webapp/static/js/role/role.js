...
function findPermissionByRoleId(id) {
    var obj = {};
    $.ajax({
        url: '../../roles/findPermissionByRoleId?id=' + id,
        type: 'get',
        async: false,
        success: (data) => {
            obj = data;
...
function permissionBtn(id) {
    ...
    $(function () {
        ...
        $.ajax({
            url: '../../roles/getZTreeForRolePermissionAll?id=' + id,
            type: 'get',
            dataType: "json",
            success: (data) => {
                console.log(data);
...
function surePermission() {
    ...
    //提交
    $.ajax({
        url: '../../roles/updateRolesPermissions',
        type: 'post',
        dataType: 'json',
